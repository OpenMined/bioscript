...
fn apol1_script_matches_simple_example_file() {
    run_apol1_case("old/examples/apol1/test_snps.txt", "P001", "G1/G0");
}

#[test]
fn apol1_script_matches_real_ddna_files() {
    run_apol1_case(
        "old/examples/apol1/genotype_files/108179_G0G0_X_X_GSAv3-DTC_GRCh38-12-13-2025.txt",
        "108179_G0G0",
        "G0/G0",
    );
    run_apol1_case(
        "old/examples/apol1/genotype_files/108187_G2G1_X_X_GSAv3-DTC_GRCh38-12-13-2025.txt",
        "108187_G2G1",
        "G2/G1",
    );
    run_apol1_case(
        "old/examples/apol1/genotype_files/108189_G2G2_X_X_GSAv3-DTC_GRCh38-12-13-2025.txt",
        "108189_G2G2",
        "G2/G2",
    );
}
