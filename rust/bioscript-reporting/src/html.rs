...
mod tests {
    ...
    fn report(participant_id: &str) -> serde_json::Value {
        ...
        json!({
            ...
            "manifest": {
                ...
                "name": "pgx-panel",
                "label": "PGx Panel",
                "summary": "Panel-level summary text.",
    ...
    fn render_app_html_document_covers_report_sections() {
        ...
        assert!(html.contains("Panel-level summary text."));
        assert!(html.contains("https://example.test/panel-summary"));
